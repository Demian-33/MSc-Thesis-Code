...
muestra_VB <- mod_sn$variational(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\log-normal\VB-8020)',
  data = dat,
  seed = 123,
  init = list(init_list),
  draws = 1000,
...
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraVB-log-normal-sesgado-8020.RData)',
     muestra_VB)
...
muestra_probitVB <- mod_sn$variational(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\probit\VB-8020)',
  data = dat,
  seed = 123,
  init = list(init_list),
  draws = 1000,
...
tproc_vb <- c(tproc_vb, (proc.time()-t0)[3])
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraVB-probit-sesgado-8020.RData)',
     muestra_probitVB)
...
muestra_probitordVB <- mod_sn$variational(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\probit-ordenado\VB-8020)',
  data = dat,
  seed = 123,
  init = list(init_list),
  draws = 1000,
...
tproc_vb <- c(tproc_vb, (proc.time()-t0)[3])
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraVB-probit-ordenado-sesgado-8020.RData)',
     muestra_probitordVB)

writeLines(paste0(tproc_vb, collapse = '~'),
           con=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraVB-tiempos-8020.txt)')

cat('Done!\n')

# (4) cargar datos ====
# rm(list=ls())
# load(r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR-8020\muestraVB-log-normal-sesgado-estimacion.RData)')
# out_var <- c('rho','sigma', 'mu', 'b')
# muestra_vb <- muestra_VB$summary(variables = out_var, out_stan)
# print(muestra_vb, n=40)
# muestra_VB$output_files() # puede vivir en documents sin problema :)
