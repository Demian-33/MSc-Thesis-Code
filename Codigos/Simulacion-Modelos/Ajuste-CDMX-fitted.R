...
muestra_HMC <- mod_sn$sample(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\log-normal\HMC-estimacion)',
  data = dat,
  seed = 123,
  init = list(init_list),
  chains=1,
...
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraHMC-log-normal-sesgado-estimacion.RData)',
     muestra_HMC)
...
muestra_probitHMC <- mod_sn$sample(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\probit\HMC-estimacion)',
  data = dat,
  seed = 123,
  init = list(init_list),
  chains=1,
...
tproc_hmc <- c(tproc_hmc, (proc.time()-t0)[3])
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraHMC-probit-sesgado-estimacion.RData)',
     muestra_probitHMC)
...
muestra_probitordHMC <- mod_sn$sample(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\probit-ordenado\HMC-estimacion)',
  data = dat,
  seed = 123,
  init = list(init_list),
  chains=1,
...
tproc_hmc <- c(tproc_hmc, (proc.time()-t0)[3])
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraHMC-probit-ordenado-sesgado-estimacion.RData)',
     muestra_probitordHMC)

writeLines(paste0(tproc_hmc, collapse = '~'),
           con=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraHMC-tiempos-estimacion.txt)')
