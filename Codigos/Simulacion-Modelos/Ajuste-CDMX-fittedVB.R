...
# este ajuste se realiza con toda la información disponible del Censo 2020
...
muestra_VB <- mod_sn$variational(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\log-normal\VB-estimacion)',
  data = dat,
  seed = 123,
  init = list(init_list),
  draws = 1000,
...
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraVB-log-normal-sesgado-estimacion.RData)',
     muestra_VB)
...
writeLines(paste0(tproc_vb, collapse = '~'),
           con=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraVB-tiempos-estimacion.txt)')
