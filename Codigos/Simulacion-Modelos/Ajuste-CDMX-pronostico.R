...
file <- file.path('LogSN-rho01-SSVS.stan') # pronostico, varios int
...
muestra_HMC <- mod_sn$sample(
  output_dir = r'(C:\Users\Lesau\Documents\EntornosR\log-normal\HMC-pronostico)',
  data = dat,
  seed = 123,
  init = list(init_list),
  chains=1,
...
save(file=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraHMC-log-normal-sesgado-pronostico0.RData)',
     muestra_HMC)
...
writeLines(paste0(tproc_hmc, collapse = '~'),
           con=r'(C:\Maestría_CP\Tesis\Documento-Tesis-SAOM\EntornosR\muestraHMC-tiempos-pronostico0.txt)')
