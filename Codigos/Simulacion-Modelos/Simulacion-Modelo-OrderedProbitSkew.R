...
new_dir <- 'probit-ordenado-sesgado-sim'
...
for(int in interceptos){
  ...
  if(int == 'varios'){
    ...
    if(int == 'unico'){
      mod_sn <- cmdstan_model(stan_file='OrdProbitSN-rho01-SSVS-genq-oneInt.stan', compile=T) # puede tener futuro
    } else{
      if(int == 'no'){
  ...
  for(per in porcentaje){
    ...
    ## (4.1) Fijar rutas ====
    path0 <- paste0('./probit-ordenado-sesgado-sim/muestra_vb_', per, '_', int, '.csv')
    path1 <- paste0('./probit-ordenado-sesgado-sim/predict_vb_', per, '_', int, '.csv')
    path2 <- paste0('./probit-ordenado-sesgado-sim/SSVS_vb_', per, '_', int, '.csv')
    path3 <- paste0('./probit-ordenado-sesgado-sim/mar_freq_vb_', per, '_', int, '.csv')
    ...
    ## (5.1) Fijar rutas ====
    path0 <- paste0('./probit-ordenado-sesgado-sim/muestra_hmc_', per, '_', int,  '.csv')
    path1 <- paste0('./probit-ordenado-sesgado-sim/predict_hmc_', per, '_', int,  '.csv')
    path2 <- paste0('./probit-ordenado-sesgado-sim/SSVS_hmc_', per, '_', int,  '.csv')
    path3 <- paste0('./probit-ordenado-sesgado-sim/mar_freq_hmc_', per, '_', int,  '.csv')
