...
\begin{tabular}{lll}
\hline
\bfseries Modelo de regresión & \bfseries Respuesta & \bfseries Definición \\
\hline
...
\caption{}
\end{subfigure}
\caption[Grafo dirigido acíclico que corresponde a la representación jerárquica de los modelos log-normal y probit sesgados con parámetros centrados.]{Grafo dirigido acíclico que corresponde a la representación jerárquica del modelo log-normal sesgado con parámetros centrados. Fuente: elboración propia}
\end{figure}
...
\hline
\bfseries Bloque & \bfseries Descripción \\
\hline
\endfirsthead
%% end first head
%% begin head
...
\hline
\bfseries Cantidades & \bfseries Definición \\
\hline
\endfirsthead
%% end first head
%% begin head
...
\hline
\bfseries Métrica & \bfseries Definición & \bfseries Interpretación \\ 
\hline
\endfirsthead
%% end first head
%% begin head
...
\hline
\bfseries Parámetro (s) & \bfseries Valor inicial & \bfseries Descripción \\
\hline
...
\begin{tabular}{ll}
\hline
\bfseries Tamaño ajustado & \bfseries Condición \\
\hline
