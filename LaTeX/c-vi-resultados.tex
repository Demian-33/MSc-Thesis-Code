...
De forma adicional, en la \autoref{fig:ch-vi-probit-liga} se dibuja la función liga para el modelo probit sesgado latente para los valores $\lambda_{i}\pm\{0, 1, 3\}$. En la \autoref{sec:modelo-probit} se obtiene su expresión, por comodidad, aquí se repite, además, $\eta_{ij}=\mu_{i}+\boldsymbol{x}_{ij}^{T}\boldsymbol{\beta}$. La función de enlace está dada por la expresión
\begin{equation*}
...
\caption[Estimaciones de $\rho_{i}$ en el modelo log-normal sesgado con ámbos métodos de estimación.]{Estimaciones de $\rho_{i}$ en el modelo log-normal sesgado con ámbos métodos de estimación. Fuente: elaboración propia.}
\end{figure}
...
\label{ch-vi-logsn-i-rho11}
\caption[Estimaciones de $\rho_{i}$ en el modelo probit sesgado con ámbos métodos de estimación.]{Estimaciones de $\rho_{i}$ en el modelo probit sesgado con ámbos métodos de estimación. Fuente: elaboración propia.}
\end{figure}
...
\caption[Estimaciones de $\rho_{i}$ en el modelo probit ordenado sesgado con ámbos métodos de estimación.]{Estimaciones de $\rho_{i}$ en el modelo probit ordenado sesgado con ámbos métodos de estimación. Fuente: elaboración propia.}
\end{figure}
...
\caption{Gráficos de dispersión entre la respuesta observada (eje vertical) y la respuesta ajustada (eje horizontal). En el lado izquierdo se muestra el método BV y en el derecho HMC.}
...
\caption{Matriz de confusión entre la respuesta observada (eje vertical) y la respuesta ajustada (eje horizontal). En el lado izquierdo se muestra el método BV y en el derecho HMC.}
...
\caption[Estadísticos resumen del ingreso corriente total per cápita por alcaldía y ámbito.]{Estadísticos resumen del ingreso corriente total per cápita por alcaldía y ámbito. Fuente: elaboración propia a partir de información de la ENIGH 2024.}
\label{ch-vi-cdmx-tabla-descripcion} \\
%%%%%% for xltabular
\hline
{\bfseries Alcaldia} & {\bfseries Ámbito} & {\bfseries Mínimo} & {\bfseries Mediana} & {\bfseries Media} & {\bfseries Máximo} & {\bfseries Desv. est.} & {$n_{i}$}\\
\hline	
\endhead
%%%%%%
...
\begin{table}[H]
\caption[Estadísticos resumen del ingreso corriente total per cápita por alcaldía y ámbito.]{Estadísticos resumen del ingreso corriente total per cápita por alcaldía y ámbito. Fuente: elaboración propia con información de la ENIGH 2024.}
\label{ch-vi-cdmx-tabla-descripcion-ambito}
\centering
\begin{tabular}{lRVVVVI}
\hline
{\bfseries Ámbito} & {\bfseries Mínimo} & {\bfseries Mediana} & {\bfseries Media} & {\bfseries Máximo} & {\bfseries Desv. est.} & {\bfseries $n_{i}$} \\
\hline
...
\end{subfigure}
\caption[En el lado izquierdo (derecho) se indica el número de observaciones binarias (ordinales) de acuerdo a la categoría que pertenecen y al ámbito.]{En el lado izquierdo (derecho) se indica el número de observaciones binarias (ordinales) de acuerdo a la categoría que pertenecen y al ámbito. Fuente: elaboración propia.}
...
%\cline{2-5}
{\bfseries Alcaldía} & {\makecell{\bfseries Población bajo \\ \bfseries LPI (\%)}} & {\makecell{\bfseries Población bajo \\ \bfseries LPEI (\%)}} & {\makecell{\bfseries Población bajo \\ \bfseries LPI (\%)}} & {\makecell{\bfseries Población bajo \\ \bfseries LPEI (\%)}} \\
\hline
\endhead
%%%%%%
...
\caption{}
\end{subfigure}
\caption[Gráficos de dispersión entre la respuesta observada (eje vertical) y la respuesta ajustada (eje horizontal)]{Gráficos de dispersión entre la respuesta observada (eje vertical) y la respuesta ajustada (eje horizontal). En el lado izquierdo se muestra el método BV y en el derecho HMC.}
...
\end{subfigure}
\caption[Gráficos de dispersión entre la respuesta observada (eje vertical) y la respuesta ajustada (eje horizontal).]{Gráficos de dispersión entre la respuesta observada (eje vertical) y la respuesta ajustada (eje horizontal). En el lado izquierdo se muestra el método BV y en el derecho HMC. Fuente: elaboración propia.}
...
%\cline{2-3}
{\bfseries Alcaldía} & {\makecell{\bfseries Población bajo \\ \bfseries LPI (\%)}} & {\makecell{\bfseries Población bajo \\ \bfseries LPI (\%)}} \\
\hline
\endhead
%%%%%%
...
\label{ch-vi-cdmx-probitord-metricas}
\begin{tabular}{lQQ}
\hline
\bfseries Métrica & {\bfseries Bayes Variacional} & {\bfseries Hamiltoniano MC} \\
\hline
