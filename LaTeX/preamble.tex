...
\newcommand{\siunitxcolnames}[0]{{Par.} & {Valor real} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%}}

\newcommand{\siunitxcolnamess}[0]{{Par.} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%}}

\newcommand{\siunitxcolnamesss}[0]{{Par.} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%}}

\newcommand{\siunitxcolnamesi}[0]{{Par.} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%} & {$\hat{R}$}}

\newcommand{\siunitxcolnamesii}[0]{{$\boldsymbol{\beta}$} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%} & {Media p.} & {I.C. 2.5\%} & {I.C. 97.5\%} & {$\hat{R}$}}
